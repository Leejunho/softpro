...
import com.example.myapplication.activity.activity_chat_chat;
import com.example.myapplication.info.chatRoomInfo;
...
public class fragment_chat_chatRoom extends Fragment {

    private SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
    private RecyclerViewAdapter mAdapter;

    public fragment_chat_chatRoom() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chat_chatroom, container, false);
                    ...
                    .addSnapshotListener(new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot value,
                            ...
                            for (QueryDocumentSnapshot doc : value) {
                                userList.put(doc.getId(), doc.toObject(memberInfo.class));
                            }
                            getRoomInfo();
                        }
                    });
...
//                    a.orderBy("timestamp", Query.Direction.DESCENDING)
                    .addSnapshotListener(new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot value,
                            ...
                            TreeMap<Date, chatRoomInfo> orderedRooms = new TreeMap<Date, chatRoomInfo>(Collections.reverseOrder());
                            ...
                            for (final QueryDocumentSnapshot document : value) {
                                 ...
                                 */
                                chatMessageInfo message = document.toObject(chatMessageInfo.class);
                                if (message.getMsg() !=null & message.getTimestamp() == null) {continue;} // FieldValue.serverTimestamp is so late

                                chatRoomInfo chatRoomModel = new chatRoomInfo();
                                ...
                                if (users.size()==2) {
                                    for( String key : users.keySet() ){
                                        ...
                                        memberInfo userModel = userList.get(key);
                            ...
                            roomList.clear();
                            for(Map.Entry<Date, chatRoomInfo> entry : orderedRooms.entrySet()) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat_chatroom, parent, false);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            final chatRoomInfo chatRoomModel = roomList.get(position);
            ...
            roomViewHolder.itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), activity_chat_chat.class);
