...
import com.example.myapplication.adapter.adapter_delivery_delivery;
...
public class activity_delivery_delivery extends activity_main_basic {
    private FirebaseUser user;
    private FirebaseFirestore db;
    private RelativeLayout loaderLayout;
    private com.example.myapplication.info.deliveryInfo deliveryInfo;
    private adapter_delivery_delivery deliveryAdapter;
    private ArrayList<com.example.myapplication.info.deliveryInfo> deliveryList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_deliverystatus);
        ...
        deliveryAdapter = new adapter_delivery_delivery(activity_delivery_delivery.this, deliveryList);
        deliveryAdapter.setOnPostListener(onPostListener);

        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new GridLayoutManager(activity_delivery_delivery.this, 1));  // 게시판 spanCount:1 줄씩 표시
        ...
        if (mBluetoothAdapter.isEnabled()) {
            ...
            if (mPairedDevices.size() > 0) {
                ...
                showToast(activity_delivery_delivery.this, "페어링된 장치가 없습니다");
            }

        }
        else {
            showToast(activity_delivery_delivery.this, "블루투스가 비활성화 되어 있습니다.");
        }
            ...
            db.collection("delivery").document(boxnum)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            showToast(activity_delivery_delivery.this, "택배함을 열었습니다");
                            deliveryUpdate();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            showToast(activity_delivery_delivery.this, "택배함을 열지 못하였습니다");
                        }
                    });
        }
    };
            ...
            db.collection("delivery").document(deliveryInfo.getBoxnum())
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            showToast(activity_delivery_delivery.this, "택배가 도착했습니다");
                            deliveryUpdate();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            loaderLayout.setVisibility(View.GONE);
                            showToast(activity_delivery_delivery.this, "실패");
                        }
                    });
        }
    }
